            ...
            <Tabs defaultActiveKey='1'>
              ...
              </TabPane>
              {
                ...
                R.filter(isEvent, transBox).map((item, index) => {
                  return <TabPane tab={`变压器${index + 1}`} key={`变压器${index + 1}`}>
              ...
              }
              {
                ...
                R.filter(isEvent, oneUnit).map((one, index) => {
                  return <TabPane tab={`${one.name}${index + 1}`} key={`${one.name}${index + 1}`}>
              ...
              }
              {
                ...
                R.filter(isEvent, outerUnit).map((outer, index) => {
                  return <TabPane tab={`${outer.name}${index + 1}`} key={`${outer.name}${index + 1}`}>
              ...
              }
              {
                ...
                R.filter(isEvent, twoUnit).map((two, index) => {
                  return <TabPane tab={`${two.name}${index + 1}`} key={`${two.name}${index + 1}`}>
